...
// Alike License. https://creativecommons.org/licenses/by-nc-sa/4.0/legalcode
...
epsilon = $preview
              ? 0.02
              : 0;  // extend cuts by a bit to fight z-fighting during preview
...
DIV_FRAME_CUTOUT_B = "div_frame_cutout";
DIV_FRAME_CUTOUT_WIDTH_PCT = "div_frame_cutout_width_percent";
...
BOX_NO_LID_B = "no_lid";
BOX_MULTIPLE = "multiple";
BOX_MULTIPLE_LID = "multiple_lid";
CMP_LID_BACKGROUND_B = "lib_background";
...
LID_LABELS_INVERT_FILL_B = "lid_label_inverted_fill";
...
CMP_COMPARTMENT_CUSTOM_B = "compartment_custom";
CMP_COMPARTMENT_CUSTOM_COUNT = "compartment_custom_count";
CMP_SHAPE = "shape";
...
CMP_FILLET_SIDES_4B = "fillet_sides";
...
function __value(table, key, default = false) =
    __index_of_key(table, key) == []
        ? default
        : table[__index_of_key(table, key)][k_value];
...
// thickness of detent. For a looser snap fit, reduce this. For a tighter snap
// fit, increase it.  ( recommended 0.05 increments )
...
// if printing in multiple materials, which layer to output.
//
g_print_mmu_layer =
    "default";  // [ "default" | "mmu_box_layer" | "mmu_label_layer" ]

m_tab_corner_gap = 4;
m_wall_underside_lid_storage_depth = 7;
m_corner_width = 6;

m_component_compartment_custom_width = g_wall_thickness + 2 * g_tolerance;
...
function __is_element_isolated_for_print() =
    g_isolated_print_box != "" &&
    (__index_of_key(data, g_isolated_print_box) != []);

function __is_element_enabled(lmnt) = __value(lmnt, ENABLED_B, default = true);

function __element_dimensions(lmnt) =
    __type(lmnt) == DIVIDERS
        ? [ __div_frame_size(lmnt)[k_x], __div_total_height(lmnt) ]
        : __value(lmnt, BOX_SIZE_XYZ, default = [ 100, 100 ]);

function __element_position_x(i) =
    __element(i - 1) == undef ? 0
    : __is_element_enabled(__element(i - 1))
        ? __element_dimensions(__element(i - 1))[k_x] +
              __element_position_x(i - 1) + DISTANCE_BETWEEN_PARTS
        : __element_position_x(i - 2);
...
function __div_tab_enabled(div) = __value(div, DIV_TAB_B, default = true);
function __div_tab_size(div) = __value(div,
                                       DIV_TAB_SIZE_XY,
                                       default = [ 32, 14 ]);
...
function __div_tab_cycle_start(div) = __value(div,
                                              DIV_TAB_CYCLE_START,
                                              default = 1);

function __div_total_height(div) = __div_tab_size(div)[k_y] +
                                   __div_frame_size(div)[k_y];

function __div_tab_text(div) = __value(div,
                                       DIV_TAB_TEXT,
                                       default = [ "001", "002", "003" ]);
function __div_tab_text_size(div) = __value(div,
                                            DIV_TAB_TEXT_SIZE,
                                            default = 7);
function __div_tab_text_font(div) = __value(div,
                                            DIV_TAB_TEXT_FONT,
                                            default = "Stencil Std:style=Bold");
function __div_tab_text_spacing(div) = __value(div,
                                               DIV_TAB_TEXT_SPACING,
                                               default = 1.1);
function __div_tab_text_char_threshold(div) =
    __value(div, DIV_TAB_TEXT_CHAR_THRESHOLD, default = 4);

function __div_tab_size(div) = __value(div,
                                       DIV_TAB_SIZE_XY,
                                       default = [ 32, 14 ]);

function __div_frame_size(div) = __value(div,
                                         DIV_FRAME_SIZE_XY,
                                         default = [ 80, 80 ]);
function __div_frame_top(div) = __value(div, DIV_FRAME_TOP, default = 10);
function __div_frame_cutout(div) = __value(div,
                                           DIV_FRAME_CUTOUT_B,
                                           default = f);
function __div_frame_cutout_width(div) = __value(div,
                                                 DIV_FRAME_CUTOUT_WIDTH_PCT,
                                                 default = 0.5);
...
function __div_frame_radius(div) =
    max(g_tolerance, __value(div, DIV_FRAME_RADIUS, default = 4));
function __div_frame_num_columns(div) = __value(div,
                                                DIV_FRAME_NUM_COLUMNS,
                                                default = -1);

// is the text a string or a list of strings?
function __is_text(label) = is_string(__value(label, LBL_TEXT)) ||
                            is_list(__value(label, LBL_TEXT));
...
function __label_text(label, r = 0, c = 0) =
    __is_text(label)
        ? (__is_multitext(label) ? __value(label, LBL_TEXT, default = "")[c][r]
                                 : __value(label, LBL_TEXT, default = ""))
        : "";
function __label_image(label, r = 0, c = 0) =
    !__is_text(label) ? (__is_multiimage(label)
                             ? __value(label, LBL_IMAGE, default = "")[c][r]
                             : __value(label, LBL_IMAGE, default = ""))
                      : "";
...
function __label_size(label) = __label_size_is_auto(label)
                                   ? 10
                                   : __label_size_raw(label);
function __label_rotation_raw(label) = __value(label, ROTATION, default = 0) %
                                       360;
function __label_rotation(label) = __label_rotation_raw(label) +
                                   (__label_placement_is_left(label)    ? 90
                                    : __label_placement_is_right(label) ? -90
                                    : __label_placement_is_front(label) &&
                                            __label_placement_is_wall(label)
                                        ? 0
                                        : 0);
function __label_depth(label) = __value(label, LBL_DEPTH, default = 0.2);
function __label_placement_raw(label) = __value(label,
                                                LBL_PLACEMENT,
                                                default = CENTER);
function __label_placement_is_center(label) =
    __label_placement_raw(label) == CENTER;
function __label_placement_is_back(label) =
    __label_placement_raw(label) == BACK ||
    __label_placement_raw(label) == BACK_WALL;
function __label_placement_is_front(label) =
    __label_placement_raw(label) == FRONT ||
    __label_placement_raw(label) == FRONT_WALL;
function __label_placement_is_left(label) =
    __label_placement_raw(label) == LEFT ||
    __label_placement_raw(label) == LEFT_WALL;
function __label_placement_is_right(label) =
    __label_placement_raw(label) == RIGHT ||
    __label_placement_raw(label) == RIGHT_WALL;
function __label_placement_is_bottom(label) =
    __label_placement_raw(label) == BOTTOM;
...
function __label_offset(label) = __value(label,
                                         POSITION_XY,
                                         default = [ 0, 0 ]);
function __label_font(label) = __value(label, LBL_FONT, default = font);
function __label_spacing(label) = __value(label, LBL_SPACING, default = 1);
function __label_scale_magic_factor(label) =
    1.2 + (1 * abs(tan(__label_rotation(label) % 90)));
function __label_auto_width(label, x, y) =
    __label_size_is_auto(label) ? (cos(__label_rotation(label)) *
                                   (x / __label_scale_magic_factor(label))) +
                                      (abs(sin(__label_rotation(label))) *
                                       (y / __label_scale_magic_factor(label)))
    : __is_text(label) ? 0
                       : __label_size(label);

module Colorize() {
  if (g_b_vis_actual) {
    color(rands(0, 1, 3), 0.5) children();
  } else {
    children();
  }
}
...
module Shear(x, y, height) {
  ...
  multmatrix(m = [ [ 1, 0, tan(x), 0 ], [ 0, 1, sin(y), 0 ], [ 0, 0, 1, 0 ] ])
      translate([ 0, 0, -height / 2 ])
  children();
}
...
module MakeAll() {
  ...
  if (__is_element_isolated_for_print()) {
    ...
    for (i = [0:__num_elements() - 1]) {
      ...
      element_position = (g_b_vis_actual && __box_vis_position(element) != [])
                             ? __box_vis_position(element)
                             : [ __element_position_x(i), 0, 0 ];
      element_rotation =
          (g_b_vis_actual && __box_vis_rotation(element) != undef)
              ? __box_vis_rotation(element)
              : 0;
...
module MakeDividers(div) {
  ...
  tab_enable = __div_tab_enabled(div);
  ...
  divider_cutout = __div_frame_cutout(div);
  diviver_cutout_width = __div_frame_cutout_width(div);
  ...
  module MakeDivider(title, tab_offset) {
    ...
    gap_size =
        (width - ((2 + num_columns) * divider_column)) / (num_columns + 1);

    difference() {
      MakeRoundedCubeAxis([ width, height, depth ], divider_corner_radius,
                          [ t, t, t, t ], k_z);
      ...
      if (num_columns != -1) {
        for (c = [0:num_columns]) {
          if (divider_cutout) {
            translate([
              divider_column + (divider_column + gap_size) * c, divider_bottom,
              0
            ])
            union() {
              MakeRoundedCubeAxis(
                  [ gap_size, height - divider_bottom + g_tolerance, depth ],
                  divider_corner_radius, [ t, t, f, f ], k_z);
              translate([
                -divider_corner_radius,
                height - divider_bottom - divider_corner_radius, 0
              ])
              difference() {
                cube([ divider_corner_radius, divider_corner_radius, depth ]);
                cylinder(r = divider_corner_radius, h = depth);
              };
              translate([
                gap_size, height - divider_bottom - divider_corner_radius, 0
              ])
              difference() {
                cube([ divider_corner_radius, divider_corner_radius, depth ]);
                translate([ divider_corner_radius, 0, 0 ])
                cylinder(r = divider_corner_radius, h = depth);
              }
            }
          } else {
            ...
            MakeRoundedCubeAxis(
                [ gap_size, height - divider_bottom - divider_top, depth ], 4,
                [ t, t, t, t ], k_z);
          }
        }
      }
    ...
    if (tab_enable) {
      ...
      difference() {
        ...
        translate(title_pos)
        {
          MakeRoundedCubeAxis([ tab_width, tab_height + height_overlap, depth ],
                              4, [ f, f, t, t ], k_z);
        }
        ...
        resize([ text_width, 0, 0 ], auto = [ true, true, false ])
            linear_extrude(depth) text(
                text = title, font = font, size = font_size, valign = "top",
                halign = "center", spacing = font_spacing, $fn = fn);
      }
    }
  }
}
...
module MakeBox(box) {
  ...
  m_wall_thickness =
      g_b_fit_test
          ...
          : __value(
                box, "wall_thickness",
                default = g_wall_thickness);  // needs work to change if no lid
  ...
  m_lid_inset =
      m_box_is_stackable || __value(m_lid, LID_INSET_B, default = false);

  // the part of the lid that overlaps the box
  m_lid_wall_height =
      __value(m_lid, LID_HEIGHT, default = m_lid_inset ? 2.0 : 4.0);
  m_lid_wall_thickness =
      m_lid_inset ? 2 * m_wall_thickness : m_wall_thickness / 2;

  m_lid_thickness = m_wall_thickness;

  m_box_has_lid = !__value(box, BOX_NO_LID_B, default = false);
  m_box_multiple_count = $preview ? 1 : __value(box, BOX_MULTIPLE, default = 1);
  m_box_multiple_lid_count =
      $preview ? 1 : __value(box, BOX_MULTIPLE_LID, default = 1);
  ...
  function __lid_external_size(D) =
      D == k_z ? m_lid_thickness + m_lid_wall_height : m_box_size[D];

  m_has_solid_lid = m_lid_solid || g_b_vis_actual;
  m_lid_has_labels = !!__value(m_lid, LABEL, default = false);

  function __lid_internal_size(D) =
      D == k_z ? m_lid_wall_height
               : __lid_external_size(D) - 2 * m_lid_wall_thickness;

  m_lid_cutout_sides =
      __value(m_lid, LID_CUTOUT_SIDES_4B, default = [ f, f, f, f ]);
  m_lid_is_inverted = __value(m_lid, LID_LABELS_INVERT_B, default = false);
  m_lid_is_inverted_fill =
      __value(m_lid, LID_LABELS_INVERT_FILL_B, default = false);
  m_lid_label_depth =
      __value(m_lid, LID_SOLID_LABELS_DEPTH, default = m_lid_thickness / 2);

  m_lid_tab_sides = __value(m_lid, LID_TABS_4B, default = [ t, t, t, t ]);

  m_lid_label_bg_thickness =
      __value(m_lid, LID_LABELS_BG_THICKNESS, default = 2.0);
  m_lid_label_border_thickness =
      __value(m_lid, LID_LABELS_BORDER_THICKNESS, default = 0.3);
  ...
  m_lid_pattern_row_offset =
      __value(m_lid, LID_PATTERN_ROW_OFFSET, default = 50);
  m_lid_pattern_col_offset =
      __value(m_lid, LID_PATTERN_COL_OFFSET, default = 100);
  m_lid_pattern_thickness =
      __value(m_lid, LID_PATTERN_THICKNESS, default = 0.5);
  ...
  m_lid_tab = [
    max(m_box_size[k_x] / 4, g_detent_spacing * 2), m_wall_thickness,
    __lid_external_size(k_z) + 1
  ];

  m_box_inner_position_min =
      [ m_wall_thickness, m_wall_thickness, m_wall_thickness ];
  m_box_inner_position_max = m_box_size - m_box_inner_position_min;

  module MakeCorners(mod = 0) {
    difference() {
      cube([
        m_box_size[k_x], m_box_size[k_y],
        m_box_size[k_z] + __lid_external_size(k_z)
      ]);  // outer box

      translate([ 0, m_corner_width + mod, 0 ])
      cube([
        m_box_size[k_x], m_box_size[k_y] - 2 * (m_corner_width + mod),
        m_box_size[k_z] + __lid_external_size(k_z)
      ]);  // middle y

      translate([ m_corner_width + mod, 0, 0 ])
      cube([
        m_box_size[k_x] - 2 * (m_corner_width + mod), m_box_size[k_y],
        m_box_size[k_z] + __lid_external_size(k_z)
      ]);  // middle x

      translate([ m_wall_thickness, m_wall_thickness, 0 ])  // innerbox
      cube([
        m_box_size[k_x] - 2 * m_wall_thickness,
        m_box_size[k_y] - 2 * m_wall_thickness,
        m_box_size[k_z] + __lid_external_size(k_z)
      ]);
    }
  }
  ...
  if (m_box_is_spacer) {
    ...
    if (g_b_print_lid && m_box_has_lid && m_box_multiple_lid_count > 0) {
      for (i = [0:m_box_multiple_lid_count - 1]) {
        translate([
          0,
          (m_box_size[k_y] + 2 * g_wall_thickness) *
              (i + m_box_multiple_count - 1),
          0
        ])
    ...
    if (g_b_print_box && m_box_multiple_count > 0) {
      for (i = [0:m_box_multiple_count - 1]) {
        translate([ 0, (m_box_size[k_y] + 2 * g_wall_thickness) * i, 0 ])
        difference() {
              ...
              for (i = [0:m_num_components - 1]) {
                if (box[i][k_key] == BOX_COMPONENT) {
                  ...
                  union() {
                    ...
                    MakeLayer(component,
                              layer = "final_component_subtractions");
                  }
                }
              }
            }
            intersection() {
              MakeLayer(layer = "background");
              difference() {
                union() {
                  for (i = [0:m_num_components - 1]) {
                    if (box[i][k_key] == BOX_COMPONENT) {
                      component = box[i][k_value];
                      MakeLayer(component, layer = "component_background");
                    }
                  }
                }
                union() {
                  for (i = [0:m_num_components - 1]) {
                    if (box[i][k_key] == BOX_COMPONENT) {
                      component = box[i][k_value];
                      MakeLayer(component,
                                layer = "component_background_cutout");
                    }
                  }
                }
              }
  ...
  module MakeLayer(component, layer = "") {
    ...
    m_is_background = layer == "background";

    // we don't use position for the box or the lid. Only for components.
    m_ignore_position =
        m_is_outerbox || m_is_lid || m_is_spacer || m_is_lid_subtractions;

    m_is_component_subtractions = layer == "component_subtractions";
    m_is_component_additions = layer == "component_additions";
    m_is_component_background = layer == "component_background";
    m_is_component_background_cutout = layer == "component_background_cutout";
    ...
    function __compartment_size(D) = __value(
        component, CMP_COMPARTMENT_SIZE_XYZ, default = [ 10.0, 10.0, 10.0 ])[D];
    function __compartments_num(D) =
        __value(component, CMP_NUM_COMPARTMENTS_XY, default = [ 1, 1 ])[D];

    function __component_rotation() = __value(component, ROTATION, default = 0);
    function __is_component_enabled() =
        __value(component, ENABLED_B, default = true);

    /////////

    m_component_margin_side =
        __value(component, CMP_MARGIN_FBLR, default = [ 0, 0, 0, 0 ]);

    function __component_margin_start_axis(D) =
        D == k_x   ? m_component_margin_side[k_left]
        : D == k_y ? m_component_margin_side[k_front]
                   : 0;

    function __component_margins_sum(D) =
        D == k_x
            ? m_component_margin_side[k_left] + m_component_margin_side[k_right]
        : D == k_y
            ? m_component_margin_side[k_front] + m_component_margin_side[k_back]
            : 0;

    m_component_cutout_side = __value(component, CMP_CUTOUT_SIDES_4B,
                                      default = [ false, false, false, false ]);

    m_component_has_side_cutouts =
        m_component_cutout_side[k_front] || m_component_cutout_side[k_back] ||
        m_component_cutout_side[k_left] || m_component_cutout_side[k_right];

    m_component_background =
        __value(component, CMP_LID_BACKGROUND_B, default = false);
    m_component_compartment_custom =
        __value(component, CMP_COMPARTMENT_CUSTOM_B, default = false);
    m_component_compartment_custom_count =
        __value(component, CMP_COMPARTMENT_CUSTOM_COUNT, default = 4);
    m_component_cutout_corner =
        __value(component, CMP_CUTOUT_CORNERS_4B,
                default = [ false, false, false, false ]);

    m_component_cutout_type =
        __value(component, CMP_CUTOUT_TYPE, default = BOTH);
    m_component_cutout_bottom =
        __value(component, CMP_CUTOUT_BOTTOM_B, default = false);
    m_component_cutout_bottom_percent =
        __value(component, CMP_CUTOUT_BOTTOM_PCT, default = 80) / 100;
    m_actually_cutout_the_bottom =
        !__component_is_fillet() && m_component_cutout_bottom && !m_push_base;
    ...
    m_component_has_exactly_one_cutout =
        (m_component_cutout_side[k_front] ? 1 : 0) +
            ...
            (m_component_cutout_side[k_right] ? 1 : 0) ==
        1;

    m_cutout_height_pct =
        __value(component, CMP_CUTOUT_HEIGHT_PCT, default = 100) / 100;
    m_cutout_size_frac_aligned =
        __value(component, CMP_CUTOUT_DEPTH_PCT, default = 25) / 100;
    m_cutout_size_frac_perpindicular =
        __value(component, CMP_CUTOUT_WIDTH_PCT, default = 50) / 100;

    function __component_padding(D) =
        __value(component, CMP_PADDING_XY, default = [ 1.0, 1.0 ])[D];
    function __component_padding_height_adjust(D) = __value(
        component, CMP_PADDING_HEIGHT_ADJUST_XY, default = [ 0.0, 0.0 ])[D];
    function __component_shape() =
        __value(component, CMP_SHAPE, default = SQUARE);
    function __component_shape_rotated_90() =
        __value(component, CMP_SHAPE_ROTATED_B, default = false);
    function __component_shape_vertical() =
        __value(component, CMP_SHAPE_VERTICAL_B, default = false);
    ...
    function __component_fillet_radius() =
        __value(component, CMP_FILLET_RADIUS,
                default = min(__compartment_size(k_z), 10));
    m_component_fillet_sides =
        __value(component, CMP_FILLET_SIDES_4B, default = [ f, t, f, t ]);

    function __component_shear(D) =
        __value(component, CMP_SHEAR, default = [ 0.0, 0.0 ])[D];
    ///////////

    function __partition_height_scale(D) =
        D == __Y2() ? __req_lower_partitions() ? 0.5 : 1.00 : 1.00;

    m_component_base_height =
        m_box_size[k_z] - __component_size(k_z) - m_wall_thickness;
    ...
    function __c_p_max(D) =
        m_box_size[D] - m_wall_thickness - __component_size(D);

    /////////

    function __c_p_raw() =
        __value(component, POSITION_XY, default = [ CENTER, CENTER ]);
    function __component_position(D) = __p_i_c(D) ? __c_p_c(D)
                                       : __p_i_m(D)
                                           ? __c_p_max(D)
                                           : __c_p_raw()[D] + m_wall_thickness;

    function __component_position_max(D) =
        __component_position(D) + __component_size(D);

    function __compartment_smallest_dimension() =
        (__compartment_size(k_x) < __compartment_size(k_y))
            ? __compartment_size(k_x)
            : __compartment_size(k_y);
    function __compartment_largest_dimension() =
        (__compartment_size(k_x) > __compartment_size(k_y))
            ? __compartment_size(k_x)
            : __compartment_size(k_y);
    ...
    function __component_size(D) =
        (D == k_z) ? __compartment_size(k_z)
                   : (__compartment_size(D) * __compartments_num(D)) +
                         (__partitions_num(D) * __component_padding(D) +
                          __component_margins_sum(D));

    function __partition_height(D) =
        __component_size(k_z) + __component_padding_height_adjust(D);
    function __smallest_partition_height() =
        min(__partition_height(k_x), __partition_height(k_y));
    ...
    module ContainWithinBox() {
      ...
      if (b_needs_trimming &&
          (__component_position(k_x) < m_box_inner_position_min[k_x] ||
           ...
           __component_position(k_x) + __component_size(k_x) >
               m_box_inner_position_max[k_x] ||
           __component_position(k_y) + __component_size(k_y) >
               m_box_inner_position_max[k_y])) {
        echo("<font color='red'>WARNING: RED Component dont fit.</font>");

        color([ 1, 0, 0 ]) children();
      } else {
        children();
      }
    }
    ...
    module __ColorComponent() {
      r = !g_b_colorize ? 0.7
                        : pow(sin(pow(__component_position(k_x), 5)), 0.5);
      g = !g_b_colorize ? 0.8
                        : pow(sin(pow(__component_position(k_y), 5)), 0.3);
      b = !g_b_colorize ? 0.5 : pow(cos(pow(__component_size(k_z), 5)), 0.5);

      color([ r, g, b ]) children();
    }

    /////////////////////////////////////////

    module PositionInnerLayer() {
      ContainWithinBox() RotateAboutPoint(
          __component_rotation(), [ 0, 0, 1 ],
          [
            __component_position(k_x) + __component_size(k_x) / 2,
            __component_position(k_y) + __component_size(k_y) / 2, 0
          ])
          translate([
            __component_position(k_x), __component_position(k_y),
            m_wall_thickness
          ])
      Shear(__component_shear(k_x), __component_shear(k_y),
            __component_size(k_z)) children();
    }
    ...
    if (__is_component_enabled()) {
      ...
      if (g_print_mmu_layer == "mmu_label_layer") {
        if (m_is_lid) {
          color([ 0, 0, 1 ]) MakeDetachedLidLabels();

          color([ 0, 0, 1 ]) MakeAllBoxLabels();
        } else if (layer == "component_additions") {
          PositionInnerLayer() if (!g_b_no_labels_actual) {
        ...
        // 'outerbox' is the insert. It may contain one or more
        // 'components' that each define a repeated compartment type.
        //
        difference() {
          if (!m_lid_inset) {
            MakeBoxShell();
        ...
        if (!m_lid_inset && m_box_has_lid) {
          ...
          MirrorAboutPoint(v = [ 0, 0, 1 ],
                           pt = [ 0, 0, __lid_external_size(k_z) / 2 ])
              MakeLidBase_Cap();

          notch_pos_z =
              m_box_size[k_z] - m_lid_wall_height + __lid_notch_depth();
        ...
        if (m_lid_inset && m_box_is_stackable) {
          difference() {
            ...
            MirrorAboutPoint(v = [ 0, 0, 1 ],
                             pt = [ 0, 0, __lid_external_size(k_z) / 2 ])
                MakeLidBase_Inset(tolerance = g_tolerance,
                                  tolerance_detent_pos = g_tolerance_detent_pos,
                                  omit_detents = !m_lid_inset);
          }
        }
      ...
      } else if (m_is_background && !$preview) {
        difference() {
          cube([ m_box_size[k_x], m_box_size[k_y], m_box_size[k_z] ]);
          MakeMesh(m_box_size[k_z]);
        }
      } else {
        PositionInnerLayer() InnerLayer();
      }
    }

    module MakeLidBase_Inset(tolerance = 0, tolerance_detent_pos = 0,
                             omit_detents = false) {
      difference() {
        // main __element
        cube([
        ...
        {
          cube([
            __lid_external_size(k_x), __lid_notch_depth() + tolerance,
            __lid_external_size(k_z) / 1
          ]);
          cube([
            __lid_notch_depth() + tolerance, __lid_external_size(k_y),
            __lid_external_size(k_z) / 1
          ]);

          MirrorAboutPoint(v = [ 0, 1, 0 ], pt =
                                                [
                                                  __lid_external_size(k_x) / 2,
                                                  __lid_external_size(k_y) / 2,
                                                  m_lid_wall_height / 2
                                                ])
              MirrorAboutPoint(v = [ 1, 0, 0 ], pt = [
                __lid_external_size(k_x) / 2, __lid_external_size(k_y) / 2,
                m_lid_wall_height / 2
              ]) {
            cube([
              __lid_external_size(k_x), __lid_notch_depth() + tolerance,
        ...
        difference() {
          MakeLidEdges(extra_depth = tolerance,
                       extra_height = __lid_external_size(k_z));

          translate([ 0, 0, 0 ])
          MirrorAboutPoint(v = [ 0, 0, 1 ], pt = [
            __lid_external_size(k_x) / 2, __lid_external_size(k_y) / 2, 0
          ]) hull() {
            MakeLidEdges(extra_depth = tolerance);

            translate([ 0, 0, -__lid_notch_depth() ])
            MakeLidEdges(offset = m_wall_thickness / 2 + tolerance,
                         extra_depth = tolerance);
          }
        }
      }
      // detents
      if (!omit_detents) {
        detent_height = (__lid_external_size(k_z) + __lid_notch_depth()) / 2 +
                        tolerance_detent_pos;
        translate([ 0, 0, detent_height ])  // lower because tolerance
        MakeDetents(mod = -tolerance, offset = tolerance);
      }
    }

    module MakeLidBase_Cap(tolerance = 0, tolerance_detent_pos = 0,
                           omit_detents = false) {
      difference() {
        // main __element
        cube([
        ...
        // big hollow
        translate([
          __lid_notch_depth() - tolerance, __lid_notch_depth() - tolerance, 0
        ])
        cube([
          __lid_internal_size(k_x) + 2 * tolerance,
          __lid_internal_size(k_y) + 2 * tolerance, __lid_external_size(k_z)
        ]);
      }

      // detents
      if (!omit_detents) {
        detent_height = (m_lid_wall_height - __lid_notch_depth()) / 2 +
                        m_lid_thickness + tolerance_detent_pos;
        translate([ 0, 0, detent_height ])  // lower because tolerance
    ...
    module MakeLidEdge(extra_height = 0, extra_depth = 0, offset = 0) {
      ...
      {
        cube([
          m_box_size[k_x] - (2 * offset), __lid_notch_depth() + extra_depth,
          m_lid_wall_height +
          extra_height
        ]);

        cube([
          __lid_notch_depth() + extra_depth, m_box_size[k_y] - (2 * offset),
          m_lid_wall_height +
          extra_height
        ]);
      }
    ...
    module MakeLidEdges(extra_height = 0, extra_depth = 0, offset = 0) {
      MakeLidEdge(extra_height = extra_height, extra_depth = extra_depth,
                  offset = offset);

      MirrorAboutPoint([ 1, 0, 0 ],
                       [ m_box_size[k_x] / 2, m_box_size[k_y] / 2, 0 ])
          MirrorAboutPoint([ 0, 1, 0 ],
                           [ m_box_size[k_x] / 2, m_box_size[k_y] / 2, 0 ])
              MakeLidEdge(extra_height = extra_height,
                          extra_depth = extra_depth, offset = offset);
    }
    ...
    module MakeSpacer() {
      {
        difference() {
          ...
          cube([
            m_box_size[k_x] - (2 * m_wall_thickness),
            m_box_size[k_y] - (2 * m_wall_thickness), m_box_size[k_z]
          ]);
        }
      }
    }
    ...
    module InnerLayer() {
      if (m_is_component_subtractions) {
        // 'carve-outs' are the big shapes of the 'components.' Each is then
        // subdivided by adding partitions.

        // we carve all the way to the bottom and then fill it back up

        union() {
          cube([
            __component_size(k_x), __component_size(k_y),
            m_box_size[k_z] + __lid_external_size(k_z)
          ]);
        }
        ...
        if (m_push_base && m_component_base_height > 0) {
          ...
          InEachCompartment() translate([
            (__compartment_size(k_x) * (1 - frac)) / 2,
            (__compartment_size(k_y) * (1 - frac)) / 2, 0
          ])
          resize([ 0, 0, m_component_base_height ],
                 auto = false)              // fit it to the base
        ...
        if (m_component_compartment_custom && !$preview) {
          InEachCompartment() {
            union() {
              acc_sep_width = (m_component_compartment_custom_count - 1) *
                              m_component_compartment_custom_width;
              step_size = (__compartment_size(k_y) - acc_sep_width) /
                          (m_component_compartment_custom_count);
              for (i = [0:round(m_component_compartment_custom_count) - 2]) {
                translate([
                  -(g_wall_thickness / 2 + g_tolerance),
                  (i + 1) * step_size +
                      i * m_component_compartment_custom_width,
                  m_component_base_height
                ])
                cube([
                  __compartment_size(k_x) + g_wall_thickness + 2 * g_tolerance,
                  m_component_compartment_custom_width,
                  m_box_size[k_z] + __lid_external_size(k_z)
                ]);
              }
        ...
        if (m_component_has_side_cutouts) {
          // finger cutouts
          insetx = m_component_cutout_side[k_left]
                       ? m_cutout_size_frac_aligned * __compartment_size(k_x) +
                             m_component_margin_side[k_left]
                       : 0;
          insety = m_component_cutout_side[k_front]
                       ? m_cutout_size_frac_aligned * __compartment_size(k_y) +
                             m_component_margin_side[k_front]
                       : 0;

          // Count how many cutouts are made in each direction to substract
          // it from the size of the inner stencil box
          x_cutouts = (m_component_cutout_side[k_left] ? 1 : 0) +
                      (m_component_cutout_side[k_right] ? 1 : 0);
          y_cutouts = (m_component_cutout_side[k_front] ? 1 : 0) +
                      (m_component_cutout_side[k_back] ? 1 : 0);

          sizex =
              __component_size(k_x) -
              x_cutouts * m_cutout_size_frac_aligned * __compartment_size(k_x) -
              __component_margins_sum(k_x);
          sizey =
              __component_size(k_y) -
              y_cutouts * m_cutout_size_frac_aligned * __compartment_size(k_y) -
              __component_margins_sum(k_y);
          ...
          if (m_component_cutout_type == BOTH) {
            ...
            intersection() {
              ...
              difference() {
                ...
                translate([ insetx, insety, -m_wall_thickness ])
                cube([
                  sizex, sizey, m_box_size[k_z] + __lid_external_size(k_z)
                ]);
              }
        ...
        InEachCompartment() {
          ...
          if (m_actually_cutout_the_bottom)
            translate([
              (__compartment_size(k_x) * (1 - frac)) / 2,
              (__compartment_size(k_y) * (1 - frac)) / 2, -m_wall_thickness
            ])
          scale(v = [ frac, frac, 1 ])  // bring in the sides
              MakeCompartmentShape();
        }
      ...
      } else if (m_is_component_background && m_component_background &&
                 !$preview) {
        InEachCompartment() {
      ...
      } else if (m_is_component_background_cutout &&
                 m_actually_cutout_the_bottom) {
        frac = 0.9;
        translate([
          (__compartment_size(k_x) * (1 - frac)) / 2,
    ...
    module Tri(R = 1, t = 0.2) {
      ...
      polygon(
          [[R * cos(0 * a), R * sin(0 * a)], [R * cos(1 * a), R * sin(1 * a)],
           [R * cos(2 * a), R * sin(2 * a)],
    ...
    module Quad(R = 1, t = 0.2) {
      ...
      polygon(
          [[R * cos(0 * a), R * sin(0 * a)], [R * cos(1 * a), R * sin(1 * a)],
           [R * cos(2 * a), R * sin(2 * a)], [R * cos(3 * a), R * sin(3 * a)],
    ...
    module Hex(R = 1, t = 0.2) {
      ...
      polygon(
          [[R * cos(0 * a), R * sin(0 * a)], [R * cos(1 * a), R * sin(1 * a)],
           [R * cos(2 * a), R * sin(2 * a)], [R * cos(3 * a), R * sin(3 * a)],
           [R * cos(4 * a), R * sin(4 * a)], [R * cos(5 * a), R * sin(5 * a)],
    ...
    module Oct(R = 1, t = 0.2) {
      ...
      polygon(
          [[R * cos(0 * a), R * sin(0 * a)], [R * cos(1 * a), R * sin(1 * a)],
           [R * cos(2 * a), R * sin(2 * a)], [R * cos(3 * a), R * sin(3 * a)],
           [R * cos(4 * a), R * sin(4 * a)], [R * cos(5 * a), R * sin(5 * a)],
           [R * cos(6 * a), R * sin(6 * a)], [R * cos(7 * a), R * sin(7 * a)],
    ...
    function AddPoint(R, t, n, i = 0) =
        i == n ? []
               : concat([[
                          (R - t) * cos(i * 2 * (PI / n) * 180 / PI),
                          (R - t) * sin(i * 2 * (PI / n) * 180 / PI)
                        ]],
                        AddPoint(R, t, n, i + 1));

    function AddOrderIndex(b, e, i = 0) =
        i == e ? [] : concat(i, AddOrderIndex(b, e, i + 1));
    ...
    module Make2dShape(R, t, n1, n2) {
      if (n1 == 3 && n2 == 3)
        ...
        order =
            concat([AddOrderIndex(0, n1)], [AddOrderIndex(n1, n1 + n2, n1)]);
    ...
    module MakeStripedGrid(x = 200, y = 200, w = 1, dx = 0, dy = 0,
                           depth_ratio = 0.5, thickness = m_lid_thickness) {
    ...
    module MoveToLidInterior(tolerance = 0) {
      translate([
        m_lid_wall_thickness + tolerance, m_lid_wall_thickness + tolerance, 0
      ])
      children();
    }
    ...
    module MakeAllBoxLabels() {
      ...
      for (i = [0:len(box) - 1]) {
        if (box[i][k_key] == LABEL) {
          ...
          MakeBoxLabel(label, x, y) Helper_MakeBoxLabel(label, x, y);
        }
      }
    }
    ...
    module Make2dLidLabel(label, width, offset) {
      resize([ width, 0, 0 ], auto = true)
          offset(r = offset) if (__is_text(label)) {
        text(text = str(__label_text(label)), font = __label_font(label),
             size = __label_size(label), spacing = __label_spacing(label),
             valign = CENTER, halign = CENTER, $fn = fn);
      }
      else {
        import(str(__label_image(label)), center = true);
      }
    }
    ...
    module MakeLidLabel(label, offset = 0, thickness = m_lid_thickness) {
      ...
      auto_width = __label_auto_width(label, __lid_external_size(k_x),
                                      __lid_external_size(k_y));
      width = auto_width != 0 ? min(100, auto_width) + offset : 0;

      linear_extrude(thickness) translate([ xpos, ypos, 0 ])
    ...
    module Helper_MakeBoxLabel(label, x = 0, y = 0) {
      width = __label_auto_width(label, m_box_size[k_x] - m_lid_notch_height,
                                 m_box_size[k_y] - m_lid_notch_height);

      RotateAboutPoint(__label_rotation(label), [ 0, 1, 0 ], [ 0, 0, 0 ])
          RotateAboutPoint(90, [ 1, 0, 0 ], [ 0, 0, 0 ]) translate(
              [ __label_offset(label)[k_x], __label_offset(label)[k_y], 0 ])
      resize([ width, 0, 0 ], auto = true)
          translate([ 0, 0, -__label_depth(label) ])
      linear_extrude(height = __label_depth(label)) if (__is_text(label)) {
        text(text = str(__label_text(label, x)), font = __label_font(label),
             size = __label_size(label), spacing = __label_spacing(label),
             valign = CENTER, halign = CENTER, $fn = fn);
      }
      else {
        import(str(__label_image(label, x)), center = true);
      }
    }
    ...
    module MakeDetachedLidLabels() {
      ...
      RotateAboutPoint(g_b_vis_actual ? 180 : 0, [ 0, 1, 0 ], [
        __lid_external_size(k_x) / 2, __lid_external_size(k_y) / 2, 0
      ]) MakeAllLidLabels();
    }
    ...
    module MakeMesh(thickness) {
      linear_extrude(thickness) {
        ...
        if (!m_has_solid_lid)
          Make2DPattern(x = __lid_internal_size(k_x),
                        y = __lid_internal_size(k_y), R = R, t = t);
        else
    ...
    module MakeLid() {
      module MakeLidSurface() {
        thickness = m_lid_inset
                        ? m_lid_thickness + m_lid_wall_height - 2 * g_tolerance
                        : m_lid_thickness;

        // pattern
        difference() {
          // if it's in an inset lid then we want the pattern all the way down
          // so it's flush and holds pieces in place.
                ...
                difference() {
                  intersection() {
                    ...
                    RotateAboutPoint(theta, [ 0, 0, 1 ], [ x2 / 2, y2 / 2, 0 ])
                        MakeStripedGrid(x = x2, y = y2, w = m_lid_stripe_width,
                                        dx = m_lid_stripe_space, dy = 0,
                                        depth_ratio = 0.5,
                                        thickness = thickness);
      ...
      module Helper__BuildLid() {
        ...
        if (!m_lid_inset) {
          MakeLidBase_Cap(tolerance = g_tolerance,
                          tolerance_detent_pos = g_tolerance_detent_pos);
        } else  // new lid
        {
          if (m_lid_inset) {
            ...
            difference(tolerance = g_tolerance) {
              ...
              // hollow the center
              MoveToLidInterior() cube([
                __lid_internal_size(k_x), __lid_internal_size(k_y),
                __lid_external_size(k_z)
              ]);
            }
            ...
            // difference()
            // {
            //     cube( [ __lid_external_size( k_x ), __lid_external_size(
            //     k_y
            //     ), __lid_external_size( k_z
            //     )/2 ]   );
            ...
            //     // hollow the center
            //     MoveToLidInterior()
            //         cube([  __lid_internal_size( k_x ),
            //         __lid_internal_size( k_y ),  __lid_external_size(
            //         k_z )]);
        ...
        {
          if (m_lid_inset)
            MoveToLidInterior(tolerance = -tolerance) cube([
              __lid_internal_size(k_x) + 2 * tolerance,
              __lid_internal_size(k_y) + 2 * tolerance, __lid_external_size(k_z)
            ]);
          else
    ...
    module ForEachCompartment(D) {
...

      {
        for (a = [start:end]) {
          ...
          dim1 = m_component_margin_side[side] +
                 (__component_padding(D) + __compartment_size(D)) * a;
    ...
    module MakeSideCutouts(side, margin = false) {
      function __cutout_z() =
          m_is_lid ? m_lid_wall_height + m_lid_thickness
                   : m_box_size[k_z] +
                         __lid_external_size(k_z) * 2 * m_cutout_height_pct;
      function __padding(D) = m_is_lid ? 0 : __component_padding(D);
      function __size(D) =
          m_is_lid ? __lid_external_size(D) : __compartment_size(D);
      function __finger_cutouts_bottom() =
          m_is_lid ? __lid_external_size(k_z) - __cutout_z()
                   : -__lid_external_size(k_z) +
                         (m_box_size[k_z] * (1 - m_cutout_height_pct));
      function __round_bottom() =
          __finger_cutouts_bottom() > m_box_size[k_z] - __size(k_z);
      ...
      //  main dimension intrudes into the compartment by some fraction ( e.g.
      //  1/5 )
      main_size =
          margin ? m_component_margin_side[side] + g_wall_thickness + radius
                 : __padding(main_d) / 2 +
                       __size(main_d) * m_cutout_size_frac_aligned;
      ...
      pos_standard = [
        // front
        [
          __size(k_x) / 2 - perp_size / 2, -__padding(k_y) / 2,
        ...
        // left
        [
          -__padding(k_x) / 2, __size(k_y) / 2 - perp_size / 2,
          __finger_cutouts_bottom()
        ],
        // right
        [
          __size(main_d) - main_size + __padding(k_x) / 2,
          __size(k_y) / 2 - perp_size / 2, __finger_cutouts_bottom()
        ],
      ];
      ...
      pos_margin = [
        ...
        [
          __size(k_x) / 2 - perp_size / 2,
          -__padding(main_d) / 2 - g_wall_thickness, __finger_cutouts_bottom()
        ],
        // back
        [
          __size(k_x) / 2 - perp_size / 2,
          __component_size(k_y) - m_component_margin_side[k_back] +
              __padding(main_d) / 2 - radius,
          __finger_cutouts_bottom()
        ],
        // left
        [
        ...
        // right
        [
          __component_size(k_x) - m_component_margin_side[k_right] +
              __padding(main_d) / 2 - radius,
          __size(k_y) / 2 - perp_size / 2, __finger_cutouts_bottom()
        ],
      ...
      shape = __round_bottom()               ? [ t, t, t, t ]
              : m_actually_cutout_the_bottom ? shape_square
                                             : shape_standard[side];
    ...
    module MakeCornerCutouts(corner) {
      function __cutout_z() =
          (m_is_lid ? m_lid_wall_height + m_lid_thickness
                    : m_box_size[k_z] + __lid_external_size(k_z) * 2);
      function __padding(D) = m_is_lid ? 0 : __component_padding(D);
      function __size(D) =
          m_is_lid ? __lid_internal_size(D) : __compartment_size(D);
      function __finger_cutouts_bottom() =
          m_is_lid ? __lid_external_size(k_z) - __cutout_z()
                   : -__lid_external_size(k_z);
      ...
      pos = [
        // k_front_left
        [ -__padding(k_x) / 2, -__padding(k_y) / 2, __finger_cutouts_bottom() ],
        // k_back_right
        [
          __size(k_x) * inverse_inset, __size(k_y) * inverse_inset,
          __finger_cutouts_bottom()
        ],
        // k_back_left
        [
          __size(k_x) * inverse_inset, -__padding(k_y) / 2,
          __finger_cutouts_bottom()

        ],
        // k_front_right
        [
          -__padding(k_x) / 2, __size(k_y) * inverse_inset,
      ...
      size = [
        __padding(k_x) / 2 + __size(k_x) * inset_into_compartment_fraction,
    ...
    module AddFillets() {
      ...
      module _MakeFillet(side = true) {
        difference() {
          cube_rotated = side ? [ __compartment_size(k_x), r, r ]
                              : [ r, __compartment_size(k_y), r ];
          cube(cube_rotated);

          cylinder_translated =
              side ? [ 0, r, r ] : [ r, __compartment_size(k_y), r ];
          translate(cylinder_translated)
          {
            cylinder_rotation = side ? [ 0, 1, 0, ] : [ 1, 0, 0 ];

            rotate(v = cylinder_rotation, a = 90)
            {
              h = side ? __compartment_size(k_x) : __compartment_size(k_y);
      ...
      union() {
        if (m_component_fillet_sides[k_front]) {
          _MakeFillet(f);
        }
        if (m_component_fillet_sides[k_back]) {
          _MakeFillet(f);
          mirrorv = [ 1, 0, 0 ];
          mirrorpt = [ __compartment_size(k_x) / 2, 0, 0 ];
          MirrorAboutPoint(mirrorv, mirrorpt) _MakeFillet(f);
        }
        if (m_component_fillet_sides[k_left]) {
          _MakeFillet(t);
        }
        if (m_component_fillet_sides[k_right]) {
          _MakeFillet(t);
          mirrorv = [ 0, 1, 0 ];
          mirrorpt = [ 0, __compartment_size(k_y) / 2, 0 ];
          MirrorAboutPoint(mirrorv, mirrorpt) _MakeFillet(t);
        }
      }
    }
    ...
    module MakeVerticalShape(h, x, r) {
      ...
      cylinder_translation =
          [ __compartment_size(k_x) / 2, __compartment_size(k_y) / 2, 0 ];
    ...
    module MakeCompartmentShape() {
      ...
      if (__component_is_square()) {
        ...
        MakeVerticalShape(
            h = __compartment_size(k_z) + m_component_base_height + epsilon,
            x = x, r = r);
      } else {
        ...
        union() {
          cylinder_translation =
              __component_shape_rotated_90()
                  ? [ 0, __compartment_size(k_y) / 2, r ]
                  : [
                      __compartment_size(dim1) / 2, __compartment_size(dim2),
                      r
                    ];
            ...
            RotateAboutPoint(a = __component_shape_rotated_90() ? 90 : 0,
                             v = [ 0, 0, 1 ], pt = [ 0, 0, 0 ]) {
              {
                ...
                rotate(a = 90, v = [ 1, 0, 0 ])
                {
                  ...
                  rotate(a = __component_is_hex2()  ? 30
          ...
          translate([ 0, 0, r ])
          cube([
            __compartment_size(k_x), __compartment_size(k_y), m_box_size[k_z]
          ]);
        }
      }
    }
    ...
    module Helper_MakeLabel(label, x = 0, y = 0) {
      ...
      width = __label_auto_width(label, __compartment_size(k_x),
                                 __compartment_size(k_y));

      // since we build from the bottom--up, we need to reverse the order in
      // which we read the label rows
      label_y_reverse = (__is_text(label) && __is_multitext(label))
                            ? len(__value(label, LBL_TEXT)) - y - 1
                        : (!__is_text(label) && __is_multiimage(label))
                            ? len(__value(label, LBL_IMAGE)) - y - 1
                            : 0;

      rotate_vector = label_on_side ? [ 0, 1, 0 ] : [ 0, 0, 1 ];
      label_needs_to_be_180ed =
          __label_placement_is_front(label) && __label_placement_is_wall(label);

      RotateAboutPoint(label_needs_to_be_180ed ? 180 : 0, [ 0, 0, 1 ],
                       [ 0, 0, 0 ]) RotateAboutPoint(__label_rotation(label),
                                                     rotate_vector, [ 0, 0, 0 ])
      ...
      linear_extrude(height = __label_depth(label)) if (__is_text(label)) {
        text(text = str(__label_text(label, x, label_y_reverse)),
             font = __label_font(label), size = __label_size(label),
             spacing = __label_spacing(label), valign = CENTER, halign = CENTER,
             $fn = fn);
      }
      else {
        import(str(__label_image(label, x, label_y_reverse)), center = true);
      }
    }
    ...
    module MakeLabel(label, x = 0, y = 0) {
      ...
      if (__label_placement_is_center(label)) {
        translate(
            [ __compartment_size(k_x) / 2, __compartment_size(k_y) / 2, z_pos ])
        children();
        ...
        children();
          ...
          __compartment_size(k_x) / 2, -__component_padding(k_y) / 4,
          __partition_height(k_y) +
          z_pos
        ])
        children();
      } else if (__label_placement_is_back(label)) {
        if (__label_placement_is_wall(label))
          translate([
            __compartment_size(k_x) / 2, __compartment_size(k_y),
            z_pos_vertical
          ])
        children();
        else translate([
          __compartment_size(k_x) / 2,
          __compartment_size(k_y) + __component_padding(k_y) / 4,
          __partition_height(k_y) +
          z_pos
        ])
        children();
        ...
        children();
          ...
          -__component_padding(k_x) / 4, __compartment_size(k_y) / 2,
          __partition_height(k_y) +
          z_pos
        ])
        children();
        ...
        if (__label_placement_is_wall(label))
          translate([
            __compartment_size(k_x), __compartment_size(k_y) / 2,
            z_pos_vertical
          ])
        rotate(-90, [ 0, 0, 1 ])
        rotate(90, [ 0, 1, 0 ])
        children();
          ...
          __compartment_size(k_x) + __component_padding(k_x) / 4,
          __compartment_size(k_y) / 2, __partition_height(k_y) +
          z_pos
        ])
        children();
      }
    ...
    module MakeMargin(side) {
      if (side == k_left)
        cube([
          m_component_margin_side[k_left], __component_size(k_y),
          __partition_height(k_x) +
          m_component_base_height
        ]);
      else if (side == k_right)
        translate(
            [ __component_size(k_x) - m_component_margin_side[k_right], 0, 0 ])
      cube([
        m_component_margin_side[k_right], __component_size(k_y),
        __partition_height(k_x) +
        m_component_base_height
      ]);
      else if (side == k_front) cube([
        __component_size(k_x), m_component_margin_side[k_front],
        __partition_height(k_x) +
        m_component_base_height
      ]);
      else if (side == k_back) translate(
          [ 0, __component_size(k_y) - m_component_margin_side[k_back], 0 ])
      cube([
        __component_size(k_x), m_component_margin_side[k_back],
        __partition_height(k_x) +
        m_component_base_height
      ]);
    }
    ...
    module MakePartition(axis) {
      if (axis == k_x) {
        cube([
          __component_padding(k_x), __component_size(k_y),
          __partition_height(k_x) +
          m_component_base_height
        ]);
      } else if (axis == k_y) {
        cube([
          __component_size(k_x), __component_padding(k_y),
          __partition_height(k_y) +
          m_component_base_height
        ]);
      }
      ...
      module MakeLidCornerNotch() {
        {
          ...
          {
            cube([
              __notch_length(k_x), __lid_notch_depth(),
              m_lid_notch_height
            ]);
            cube([
              __lid_notch_depth(), __notch_length(k_y),
              m_lid_notch_height
            ]);
          }
        }
    ...
    module MakeDetents(mod = 0, offset = 0) {
      ...
      module MakeOneSet(mod) {
        ...
        hull() for (i = [0:num_detents - 1]) translate([
          m_wall_thickness / 2 + g_detent_spacing * i +
...
module MakeRoundedCubeAxis(vec3,
                           radius,
                           vecRounded = [ t, t, t, t ],
                           axis = k_z) {
  radii = [
  ...
  pos = [
    [[radii [0], 0, radii [0]], [vec3 [k_x] - radii [1], 0, radii [1]],
    ...
    [[radii [0], radii [0], 0], [vec3 [k_x] - radii [1], radii [1], 0],
     [radii [2], vec3 [k_y] - radii [2], 0],
     [vec3 [k_x] - radii [3], vec3 [k_y] - radii [3], 0]]
  ];

  rot = [ [ 270, 0, 0 ], [ 0, 90, 0 ], [ 0, 0, 0 ] ];
...
module MakeRoundedCubeAll(vecCube,
                          radius,
                          axis = k_z,
                          vecRounded = [ t, t, t, t ]) {
  radii = [
  ...
  pos = [[radii [0], radii [0], 0], [vecCube2 [k_x] - radii [1], radii [1], 0],
  ...
  RotateAboutPoint(a = 90, v = [ axis == k_x ? 1 : 0, axis == k_y ? 1 : 0, 0 ],
                   pt = vecCubeCtr) hull() {
    h = vecCube2[k_z];
